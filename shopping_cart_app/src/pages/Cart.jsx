  ...
  return (
    <div>
    {
      ...
      (<div className='flex flex-col max-w-[1200px] mx-auto md:flex-row justify-center'>
          ...
          <div className='flex flex-col p-5 gap-5 my-14 h-[100%] justify-between'>
            <div className='flex flex-col gap-3'>
              ...
              <p>
                <span className='text-gray-700 font-semibold text-xl'>Total Items: <span className='text-xl'>{cart.length}</span></span>
              </p>
              
            </div>
            <div className='flex flex-col'>
            <p className='text-gray-700 font-semibold'>Total Amount: <span className='text-xl font-bold'>${totalAmount}</span></p>
      ...
      (<div className='min-h-[80vh] flex flex-col items-center justify-center'>
        ...
        <Link to="/">
        <button
        className='bg-green-600 hover:bg-purple-50 rounded-lg text-white transition duration-300
